...
const preambles = `
    answer using the dictionary below, use as much as you can. please use at least each of these word = "skibidi","sigma","maxing","erm what a sigma", "Ohio", "cap", "chat is this real?", "fanum tax", "goofy ah", "aura". "rizz", "W", "fr fr", "baby gronk", "mewing", "fanum tax".

here the dictionary:

{
    "Skibidi": "representing absurdity and humor.",
    "Rizz": "Slang for having charm or charisma",
    ...
    "Cap": "Used to call out lies or exaggerations; if something is true, it 'no cap.'",
    "Gyatt": "An expression of surprise or admiration",
    ...
    "Clutch": "When achieving something impressive while being under pressure.",
    "OP": "Stands for 'overpowered,' usually describing a strong character.",
    ...
    "Toxic": "Describes someone who engage in negative or insulting behavior.",
    "Grinding": "Someone who working hard to level up or improve.",
    ...
    "based": "refers to something or someone as one that you agree with. but it can be used ironically or sarcastically",
    ...
    "delulu":"delusion",
    "crashout":"the term “crash out” refers to someone who takes big risks with their life and future, acting like they don’t care about what might happen next. It’s like they believe they have nothing to lose. So, when we say someone is “crashing out,” we mean they are behaving in a really reckless way.",
    ...
    "Erm, what the sigma":"said at the beginning of sentence to express something new",
    "FE!N":"“FE!N” is the title of a song by Travis Scott featuring Playboi Carti. The title originates from the word “fiend”.",
    "gooning":"“Gooning” is a state a man typically reaches after a long work session, where he becomes captivated by the sensations coming from works.",
    ...
    "Match my freak":"Refers to seeking someone with a similar skill",
    "mid":"To call something mediocre. Usually used derogatively to refer to a highly praised item or public figure.",
    "mogging":"means being more good-looking than other people, and it’s part of a trend called “looksmaxing”, which is all about making yourself look better.",
    ...
    "fr fr":"for real",
    "baby gronk":"a baby named gronk"
}

make it very unformal, and funny.
`;

async function makeCohereChatRequest(message) {
  try {
    ...
    console.error("Error making Cohere Chat API request:", error);
    throw error;
  }
}

export { makeCohereChatRequest };
